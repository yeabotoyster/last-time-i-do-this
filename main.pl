...
print q{ 
                 ...
                 |/     /\     \| 
       (@_       (_     ^^     _) 
  _     ) \_______\__|IIIIII|__/___________________________ 
 (_)@8@8{}<________|-\IIIIII/-|_N_O_M_O_R_E_W_I_F_I_S_K_I_D> 
        )_/        \          / 
       (@           `--------` Skid Slapper 4.20 
 [---]   by:> envixed   [---]
};
...
system("clear || cls");
print "\n[*]  envixed bounced that bitch off [$host:$port] proto => [$proto].......\n\n";
sleep(1);
while (1) {
...
#####################                #########################
##############################################################
#This Script is made by envixed
#Fuck Off Skid  :)
#Bounced Off the Wifi 